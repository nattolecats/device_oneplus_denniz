...
TARGET_KERNEL_ADDITIONAL_FLAGS := KBUILD_BUILD_USER="SakilMondal" KBUILD_BUILD_HOST=Compiler LLVM=1 LD=ld.lld AR=llvm-ar NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip
